...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """cancelOrder/""" + "$" + """itemId<[^/]+>""", """controllers.ShoppingCtrl.cancelOrder(itemId:Long)"""),
  ...
  // @LINE:39
  private[this] lazy val controllers_ShoppingCtrl_cancelOrder20_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("cancelOrder/"), DynamicPart("itemId", """[^/]+""",true)))
  )
  private[this] lazy val controllers_ShoppingCtrl_cancelOrder20_invoker = createInvoker(
    ...
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      ...
      Seq(classOf[Long]),
      "GET",
      this.prefix + """cancelOrder/""" + "$" + """itemId<[^/]+>""",
      """""",
      Seq()
    )
  )
  ...
  // @LINE:45
  private[this] lazy val controllers_ShoppingCtrl_viewOrders23_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("viewOrders")))
  )
  private[this] lazy val controllers_ShoppingCtrl_viewOrders23_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:39
    case controllers_ShoppingCtrl_cancelOrder20_route(params@_) =>
      call(params.fromPath[Long]("itemId", None)) { (itemId) =>
        controllers_ShoppingCtrl_cancelOrder20_invoker.call(ShoppingCtrl_1.cancelOrder(itemId))
      }
    ...
    // @LINE:45
    case controllers_ShoppingCtrl_viewOrders23_route(params@_) =>
      call { 
        controllers_ShoppingCtrl_viewOrders23_invoker.call(ShoppingCtrl_1.viewOrders())
      }
  }
}
